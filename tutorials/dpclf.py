...
def main():
    ...
    model = Net().to(device)
    optimizer = DPSGD(batch_size=args.batch_size, l2_norm_clip=args.l2_norm_clip, noise_multiplier=args.noise_multiplier, params=model.parameters(), lr=args.lr, momentum=args.momentum)
